...
import { AuroraDemo } from "@/components/projects/aurora-demo";
                ...
                <GlassCard padding="lg" className="border-t border-indigo-500/10">
                  <div className="w-full rounded-2xl border border-white/5 bg-slate-950/40 p-5 mb-6">
                    <div className="mb-4 flex items-center justify-between text-[10px] text-slate-500 font-mono">
                      <span>DATABASE MULTI-TENANT ISOLATION MODEL</span>
                      <span className="text-cyan-400">ACTIVE: ROW-LEVEL SECURITY</span>
                    </div>
                    <svg viewBox="0 0 600 160" className="w-full text-slate-400">
                      ...
                      <text x="65" y="80" textAnchor="middle" fill="#fff" fontSize="11" fontWeight="600">Client Workspace</text>
                      <text x="65" y="95" textAnchor="middle" fill="#64748b" fontSize="9">Sends JWT Claim</text>
                      ...
                      <text x="240" y="80" textAnchor="middle" fill="#818cf8" fontSize="11" fontWeight="600">Next.js API Gate</text>
                      <text x="240" y="95" textAnchor="middle" fill="#64748b" fontSize="9">Inspects Session</text>
                      ...
                      <text x="415" y="75" textAnchor="middle" fill="#22d3ee" fontSize="11" fontWeight="600">PostgreSQL (DB)</text>
                      <text x="415" y="90" textAnchor="middle" fill="#10b981" fontSize="9" fontWeight="600">RLS Check Active</text>
                      <text x="415" y="102" textAnchor="middle" fill="#64748b" fontSize="8">tenant_id = jwt.tenant</text>

                      <line x1="470" y1="80" x2="515" y2="80" stroke="#10b981" strokeWidth="1.5" markerEnd="url(#arrow-green)" />

                      <rect x="525" y="30" width="65" height="40" rx="6" fill="rgba(16,185,129,0.05)" stroke="rgba(16,185,129,0.2)" strokeWidth="1" />
                      <text x="557" y="55" textAnchor="middle" fill="#10b981" fontSize="9" fontWeight="600">Tenant A OK</text>
                      
                      <rect x="525" y="90" width="65" height="40" rx="6" fill="rgba(239,68,68,0.05)" stroke="rgba(239,68,68,0.1)" strokeWidth="1" />
                      <text x="557" y="115" textAnchor="middle" fill="#f87171" fontSize="9" fontWeight="600">Tenant B Block</text>
                    </svg>
                  </div>
