...
import { PulseChatDemo } from "@/components/projects/pulse-chat-demo";
...
export async function generateMetadata(): Promise<Metadata> {
  let project = await getProjectById("pulse-chat");
  if (!project) {
    project = (seedProjects as any[]).find((p) => p.id === "pulse-chat");
  }
  if (!project) {
...
// Custom simple markdown-like renderer to maintain design control and keep compilation light
      ...
      <div className="container-narrow max-w-4xl">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.95fr_1fr] items-start">
          ...
          <div className="space-y-8">
            ...
            {/* Interactive Streaming Sandbox Area */}
                ...
                <GlassCard padding="lg" className="border-t border-indigo-500/10">
                  <div className="w-full rounded-2xl border border-white/5 bg-slate-950/40 p-5 mb-6">
                    <div className="mb-4 flex items-center justify-between text-[10px] text-slate-500 font-mono">
                      <span>EDGE ROUTING & SSE STREAM PIPELINE</span>
                      <span className="text-cyan-400">STATUS: ACTIVE TOKEN DECODER</span>
                    </div>
                    <svg viewBox="0 0 600 160" className="w-full text-slate-400">
                      ...
                      <text x="65" y="80" textAnchor="middle" fill="#fff" fontSize="11" fontWeight="600">Client UI Chat</text>
                      <text x="65" y="95" textAnchor="middle" fill="#64748b" fontSize="9">POST Payload</text>
                      ...
                      <text x="240" y="75" textAnchor="middle" fill="#818cf8" fontSize="11" fontWeight="600">Edge Middleware</text>
                      <text x="240" y="90" textAnchor="middle" fill="#10b981" fontSize="9" fontWeight="600">Size & Skew Check</text>
                      <text x="240" y="101" textAnchor="middle" fill="#64748b" fontSize="8">Rate Limiter Gate</text>
                      ...
                      <text x="415" y="80" textAnchor="middle" fill="#22d3ee" fontSize="11" fontWeight="600">OpenAI LLM</text>
                      <text x="415" y="95" textAnchor="middle" fill="#64748b" fontSize="9">Keys Hidden Server</text>
                      ...
                      <text x="557" y="75" textAnchor="middle" fill="#10b981" fontSize="10" fontWeight="600">SSE Chunks</text>
                      <text x="557" y="90" textAnchor="middle" fill="#64748b" fontSize="8">UTF-8 Reader</text>
                    </svg>
                  </div>
          ...
          <div className="space-y-6 lg:sticky lg:top-24">
            ...
            {/* Private repository detailed warning */}
            {isPrivate && project.privateExplanation && (
              <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-6 space-y-3">
                <div className="flex items-center gap-2 text-amber-400 font-semibold text-sm">
                  <Lock className="h-4 w-4" />
                  <h3>Private Build Telemetry Notice</h3>
                </div>
                <p className="text-xs leading-relaxed text-slate-300">
                  {project.privateExplanation}
                </p>
                <div className="pt-2 border-t border-white/5">
                  ...
                  >
                    Request repository walkthrough via video call →
                  </a>
                </div>
              </div>
            )}
