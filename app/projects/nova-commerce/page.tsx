...
import { NovaCommerceDemo } from "@/components/projects/nova-commerce-demo";
...
export async function generateMetadata(): Promise<Metadata> {
  let project = await getProjectById("nova-commerce");
  if (!project) {
    project = (seedProjects as any[]).find((p) => p.id === "nova-commerce");
  }
  if (!project) {
...
export default async function NovaCommercePage() {
  let project = await getProjectById("nova-commerce");
  if (!project) {
    project = (seedProjects as any[]).find((p) => p.id === "nova-commerce");
  }
      ...
      <div className="container-narrow max-w-4xl">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.95fr_1fr] items-start">
          ...
          <div className="space-y-8">
            ...
            {/* Interactive Commerce Sandbox Section */}
                ...
                <GlassCard padding="lg" className="border-t border-indigo-500/10">
                  <div className="w-full rounded-2xl border border-white/5 bg-slate-950/40 p-5 mb-6">
                    <div className="mb-4 flex items-center justify-between text-[10px] text-slate-500 font-mono">
                      <span>SECURE HEADLESS CHECKOUT FLOW</span>
                      <span className="text-indigo-400">INTEGRITY GATEWAY ACTIVE</span>
                    </div>
                    <svg viewBox="0 0 600 160" className="w-full text-slate-400">
                      ...
                      <text x="65" y="80" textAnchor="middle" fill="#fff" fontSize="11" fontWeight="600">Headless Cart</text>
                      <text x="65" y="95" textAnchor="middle" fill="#64748b" fontSize="9">Item IDs + Qty Only</text>
                      ...
                      <text x="240" y="75" textAnchor="middle" fill="#818cf8" fontSize="11" fontWeight="600">Checkout API</text>
                      <text x="240" y="90" textAnchor="middle" fill="#10b981" fontSize="9" fontWeight="600">Server Price Lookup</text>
                      <text x="240" y="101" textAnchor="middle" fill="#64748b" fontSize="8">Client Price Discarded</text>
                      ...
                      <text x="415" y="80" textAnchor="middle" fill="#22d3ee" fontSize="11" fontWeight="600">Stripe Sessions</text>
                      <text x="415" y="95" textAnchor="middle" fill="#64748b" fontSize="9">Signs Payment Token</text>
                      ...
                      <text x="557" y="75" textAnchor="middle" fill="#10b981" fontSize="10" fontWeight="600">PCI Gate</text>
                      <text x="557" y="90" textAnchor="middle" fill="#64748b" fontSize="8">Token Redirect</text>
                    </svg>
                  </div>
