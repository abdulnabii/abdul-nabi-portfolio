...
export const siteContent: SiteContent = {
  ...
  hero: {
    greeting: "Full-Stack Developer · Data & ML · AppSec (Google Certified)",
    name: "Abdul Nabi",
    role: "Clean Next.js apps, REST APIs & ML workflows — built with security awareness.",
    description:
      "I build web products with Next.js, TypeScript, and modern APIs. Outside web engineering, I train ML models in Python (like my Blood Sugar Tracker FYP) and hold 5 Google Cybersecurity certifications covering threat modeling, network security, and Linux/SQL analysis.",
    focusLine: "Next.js · TypeScript · Python · ML Training · AppSec (OWASP Top 10)",
  ...
  about: {
    title: "About",
    paragraphs: [
      "I'm a full-stack developer who started building web applications in 2022 during my BS in Computer Science at the University of Sindh. My core engineering focus spans responsive Next.js interfaces, RESTful backends, and data/ML projects in Python — with professional product work from 2024 onward.",
      "I'm building specialization in Application Security (AppSec) — grounding it in 5 completed Google Cybersecurity courses covering NIST CSF, SIEM tools, network hardening, threat modeling, and Linux/SQL-based security analysis.",
      ...
      "I'm looking for engineering teams where I can take real feature ownership, ship quality software, and grow alongside people who care about building things right.",
    ],
    stats: [
      { label: "Building web products since", value: "2022" },
  ...
  experience: [
    {
      ...
      period: "2024 — Present",
      description:
        "Designing and shipping full-stack web features — owning complete slices from UI through API routes to database security policies, with application security baked in from the start rather than bolted on at the end.",
      highlights: [
        "Owned feature slices end-to-end across UI, API routes, and data access — including authentication flows, RBAC, and Supabase Row-Level Security policy definitions",
        "Performed application security reviews on REST APIs and Next.js routes, identifying and resolving authorization logic gaps and injection surface areas (OWASP A01/A03)",
        "Built responsive interfaces with Tailwind CSS, focusing on semantic markup, accessible forms, and clean mobile layouts that score 95+ on Lighthouse accessibility audits",
        "Integrated AI/ML capabilities into web applications, including Gemini-powered analysis tools and a scikit-learn ElasticNet regression model (Blood Sugar Tracker FYP)",
        "Completed 5 Google Cybersecurity courses (NIST CSF, SIEM tools, network hardening, threat modeling, Linux/SQL security analysis) — applying frameworks directly to code review practices",
      ],
    },
  ],
  education: [
